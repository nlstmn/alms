...
class FilesMain extends React.Component {
    ...
    static navigationOptions = ({ navigation }) => {
        ...
        return {
            title: params.languageResource !== undefined ? params.languageResource.r_menu_my_files || strings('r_menu_my_files') : strings('r_menu_my_files'),
...
export default connect(mapStateToProps, mapDispatchToProps)(FilesMain)
