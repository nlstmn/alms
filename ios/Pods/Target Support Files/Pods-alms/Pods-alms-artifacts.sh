...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AzureNotificationHubs-iOS/WindowsAzureMessaging-SDK-Apple/WindowsAzureMessaging.xcframework" "" "false" "ios-arm64_arm64e_armv7_armv7s/WindowsAzureMessaging.framework" "ios-arm64_i386_x86_64-simulator/WindowsAzureMessaging.framework" "ios-arm64_x86_64-maccatalyst/WindowsAzureMessaging.framework"
fi
